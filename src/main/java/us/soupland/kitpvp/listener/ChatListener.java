...
public class ChatListener implements Listener {
    ...
    public void onAsyncPlayerChat(AsyncPlayerChatEvent event) {
        ...
        if (profile.isCreatingTeam()) {
            ...
            if (args[0].equalsIgnoreCase("cancel")) {
                ...
                if (name.length() < 3) {
                    ...
                    if (maybeTeam != null) {
                        ...
                        Bukkit.broadcastMessage(ColorText.translate("&eTeam &9" + newTeam.getName() + " &ehas been &acreated &eby " + player.getName() + "&e."));
            ...
            event.setCancelled(true);
        } else if (profile.getLastMessage() != null && event.getMessage().equalsIgnoreCase(profile.getLastMessage()) && !player.isOp()) {
